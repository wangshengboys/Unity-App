...
final chatConversationsProvider =
    FutureProvider.family<List<ChatProfileModel>, int>((ref, userId) async {
      final response = await http.get(
        Uri.parse("${Config.baseUrl}/chat/get_conversations?user_id=$userId"),
      );
...
final chatRecommendationsProvider =
    FutureProvider.family<List<RecommendationModel>, int>((ref, userId) async {
      final response = await http.get(
        Uri.parse(
          "${Config.baseUrl}/chat/get_chat_recommendations?user_id=$userId",
        ),
      );
